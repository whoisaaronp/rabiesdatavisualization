...
function addStage1() {
    ...
    `
    imageVar.setAttribute('src', 'images/stage-1.jpg');
...
function addStage2() {
    ...
    `
    imageVar.setAttribute('src', 'images/stage-2.jpg');
...
function addStage3() {
    ...
    `
    imageVar.setAttribute('src', 'images/stage-3.jpg');
}
function addStage4() {
